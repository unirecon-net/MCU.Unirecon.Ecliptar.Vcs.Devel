...
class LightsController : public ControlHandler // @suppress("Class has a virtual method and non-virtual destructor")
{
public:
						   LightsController(){}
                           LightsController(GPIO_TypeDef* frontLightPort, GPIO_TypeDef* rearLightPort);
